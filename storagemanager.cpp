...
void StorageManager::setupLogicalSystemDir(const LogicalSystem &system, const QStringList &inferenceRulesNames)
{
    ...
    //Serialization
    storeLogicalSystemPluginsData(systemName, inferenceRulesNames);
